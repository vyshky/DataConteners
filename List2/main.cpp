...
void main()
{
	...
	for (List<int>::Iterator i = list2.begin(), j = list2.end(); i != j; ++i)
	{
		cout << *i << tab;
	}
	...
	for (List<double>::Iterator i = d_list.begin(), j = d_list.end(); i != j; ++i)	cout << *i << tab;
	cout << endl;
	...
	for (List<string>::Iterator i = s_list.begin(), j = s_list.end(); i != j; ++i)	cout << *i << tab;
	cout << endl;
}